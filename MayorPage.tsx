        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl overflow-hidden border border-gray-200 dark:border-gray-700">
                <div className="grid grid-cols-1 md:grid-cols-2">
                    {/* Image Section */}
                    <div className="relative h-[400px] md:h-auto bg-gray-200 dark:bg-gray-700 group overflow-hidden">
                        {/* Specific Cute Bear Image (White Plush/Felt style) */}
                        <img 
                            src="https://images.unsplash.com/photo-1585110396000-c9a96db275c4?q=80&w=800&auto=format&fit=crop" 
                            alt="Mayor Portrait" 
                        ...
                        />
                         <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-8 md:hidden">
                            <div>
                                <h2 className="text-3xl font-bold text-white mb-1">{m.profile.name}</h2>
                                <p className="text-white/80 text-sm">{m.profile.role}</p>
                            </div>
                         </div>
                    </div>
                    ...
                    <div className="p-8 md:p-12 flex flex-col justify-center">
                        ...
                        <div className="space-y-6 mb-8">
                            ...
                            <p className="text-lg text-gray-600 dark:text-gray-300 italic leading-relaxed font-serif border-l-4 border-brand-accent pl-4">
                                {m.profile.desc}
                            </p>
                        </div>

                        {/* Contact Box */}
                        <div className="bg-slate-50 dark:bg-slate-900 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
